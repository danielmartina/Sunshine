...
# 3) Connect Quest2. Now you should connect at 600/1200mbps with 1-5ms latency (ping to ip of the quest2 when the streaming is on. Not the VD latency)
#
...
# powershell x:\path\Start_HotSpot_Quest2.ps1
# Change x:\path with the correct path
#
# --> Create a link to the batch file and give it Admin Rights.
# 
# --> IMPORTANT NOTE: In the "Variables" part you have to change the variable $WirelessAdapterName with your Wireless Adapter Name to get the script work
#
# END GUIDE

# Variables
$WirelessAdapterName = "Wi-Fi"
